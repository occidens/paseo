...
| [docs/linux-arm64-desktop-build.md](docs/linux-arm64-desktop-build.md) | Building the desktop app for Linux arm64 locally — required system deps, why CI doesn't ship this build                        |
